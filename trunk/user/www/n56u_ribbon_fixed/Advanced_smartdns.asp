		    ...
		    <div>
						...
						<div>
                            <ul class="nav nav-tabs" style="margin-bottom: 10px;">
								...
								<li>
                                    <a id="tab_sm_exp" href="#exp">高级设置</a>
                                </li>
								<li>
                                    <a id="tab_sm_sec" href="#sec">第二服务器</a>
								</li>
								<li>
                                    <a id="tab_sm_dns" href="#dns">上游设置</a>
                                </li>
                                <li>
                                ...
                                <div class="row-fluid">
                                    ...
                                    <div id="wnd_sm_cfg">
										...
										<tr> <th width="50%">TCP 链接空闲超时时间</th>
                                            <td>
										...
										<tr> <th width="50%">返回给客户端的 TTL 最大值</th>
                                            <td>
										...
										<tr> <th width="50%">返回给客户的最大 IP 数量</th>
                                            <td>
										...
										<tr> <th width="50%">跳过nameserver规则</th>
                                            <td>
                                                <div class="main_itoggle">
                                        ...
                                        <tr> <th width="50%">跳过address SOA(#)规则</th>
                                            <td>
                                                <div class="main_itoggle">
                                        ...
                                        <tr> <th width="50%">Force AAAA SOA</th>
                                            <td>
                                                <div class="main_itoggle">
                                                ...
                                                <div><span style="color:#888;">强制 AAAA 地址返回 SOA</span></div>
                                                <div style="position: absolute; margin-left: -10000px;">
										...
										<tr> <th width="50%">Force qtype SOA</th>
                                            <td>
												...
												<div><span style="color:#888;">强制指定 qtype 返回 SOA</span></div>
                                            </td>
                                        </tr>
										<tr> <th width="50%">域名预先获取</th>
                                             <td>
                                                <div class="main_itoggle">
										...
										<tr> <th width="50%">过期缓存服务</th>
                                            <td>
                                                ...
                                                </div><span style="color:#888;">开启此功能后，如果有请求时尝试回应 TTL 为 0 的过期记录，并发查询记录，以避免查询等待</span></div>
                                                <div style="position: absolute; margin-left: -10000px;">
										...
										<tr> <th width="50%">过期缓存服务最长超时时间</th>
                                            <td>
                                                <input type="text" maxlength="64" class="input" size="15" name="sdns_exp_ttl" style="width: 200px" value="<% nvram_get_x("", "sdns_exp_ttl"); %>">
												<div><span style="color:#888;">秒，0 表示停用超时，大于 0 表示指定的超时的秒数</span></div>
                                            </td>
                                        </tr>
										<tr> <th width="50%">回应的过期缓存 TTL</th>
                                            <td>
