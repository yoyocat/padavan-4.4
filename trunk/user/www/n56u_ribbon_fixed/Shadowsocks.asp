										...
										<div class="row-fluid">
											...
											<div id="wnd_ss_cfg">
												<div class="alert alert-info" style="margin: 10px;">一个兼容Shadowsocks、ShadowsocksR 、Vmess、Vless、Trojan、Sock5协议的游戏加速工具。
													...
													<div><span style="color:#E53333;">运行状态不会实时更新，启动节点后需等待一段时间手动刷新页面获取运行状态</span></div>
												</div>
												<table width="100%" cellpadding="4" cellspacing="0" class="table">
													<tr>
														<th width="50%">客户端<#running_status#></th>
														<td id="ss_status"></td>
													</tr>
													<tr id="row_pdnsd_run">
											...
											<div id="wnd_ss_add">
												<table width="100%" cellpadding="4" cellspacing="0" class="table">
													<tr>
														<td colspan="3">
															<i class="icon-hand-right"></i> <a href="javascript:spoiler_toggle('script7')"><span>订阅地址(一行一个地址):</span></a>
															<div id="script7">
												...
												<table width="100%" cellpadding="4" cellspacing="0" class="table">
													<tr><th width="50%">关键字过滤（请以/为分隔符）</th>
														<td>
